...
function getCharacterById(id) {
  return _axios.default.get("https://rickandmortyapi.com/api/character/" + id).then(function (response) {
    return response.data;
  });
}
  ...
  try {
    var _loop = function _loop() {
      ...
      node.onclick = function () {
        DataBusiness.getCharacterById(user.char_id).then(function (dataBis) {
...
},{"./styles.css":"src/styles.css","./data-business":"src/data-business.js","./utils":"src/utils.js"}],"../../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
